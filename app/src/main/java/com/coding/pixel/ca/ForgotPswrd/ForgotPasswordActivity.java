package com.coding.pixel.ca.ForgotPswrd;
...
public class ForgotPasswordActivity extends AppCompatActivity {
        ...
        resetPassButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(email)){
                    SweetToast.error(ForgotPasswordActivity.this, "Email is required");
                } else if (!Patterns.EMAIL_ADDRESS.matcher(email).matches()){
                    SweetToast.error(ForgotPasswordActivity.this,"Email format is not valid.");
                } else {
                    ...
                    auth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void run() {
                                        ForgotPasswordActivity.this.runOnUiThread(new Runnable() {
                                            public void run() {
                                                ...
                                                SweetToast.info(ForgotPasswordActivity.this, "Please check your email.");
                        ...
                        public void onFailure(@NonNull Exception e) {
                            SweetToast.error(ForgotPasswordActivity.this, "Oops!! "+e.getMessage());
                        }
                    });
                }
            }
    ...
    private void emailSentSuccessPopUp() {
        ...
        View view = LayoutInflater.from(ForgotPasswordActivity.this).inflate(R.layout.register_success_popup, null);
