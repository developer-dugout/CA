package com.coding.pixel.ca.Comments;
...
import com.coding.pixel.ca.Model.Comments;
            ...
            PostRef.child(RandomKey).updateChildren(commentsMap)
                    .addOnCompleteListener(new OnCompleteListener() {
                        ...
                        public void onComplete(@NonNull Task task)
                        {
                            ...
                            {
                                Toast.makeText(BlogCommentsActivity.this, "You have Commented Successfully...", Toast.LENGTH_SHORT).show();
                            }
                            else
                            {
                                Toast.makeText(BlogCommentsActivity.this, "Error occurred here...", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
